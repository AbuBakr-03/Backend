...
# File upload settings - strict limits for Railway memory constraints
FILE_UPLOAD_MAX_MEMORY_SIZE = 10485760  # 10MB - files larger go to temp storage
DATA_UPLOAD_MAX_MEMORY_SIZE = 20971520  # 20MB total request size
FILE_UPLOAD_TEMP_DIR = "/tmp"  # Use Railway's temp directory
